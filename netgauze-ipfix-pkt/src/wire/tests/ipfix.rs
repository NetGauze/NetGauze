...
fn test_options_template_packet() -> Result<(), IpfixPacketWritingError> {
    ...
    let good = IpfixPacket::new(
        ...
        vec![Set::OptionsTemplate(vec![OptionsTemplateRecord::new(
            308,
            vec![FieldSpecifier::new(ie::InformationElementId::ipClassOfService, 1).unwrap()],
            vec![
                FieldSpecifier::new(ie::InformationElementId::flowActiveTimeout, 2).unwrap(),
                FieldSpecifier::new(ie::InformationElementId::flowIdleTimeout, 2).unwrap(),
            ],
        )])],
    );
        ...
        vec![Set::OptionsTemplate(
                vec![
                    OptionsTemplateRecord::new(
                        512,
                vec![
                    FieldSpecifier::new(ie::InformationElementId::exportingProcessId, 4).unwrap()
                ],
                vec![
                    FieldSpecifier::new(ie::InformationElementId::exportedMessageTotalCount, 8).unwrap(),
                    FieldSpecifier::new(ie::InformationElementId::exportedFlowRecordTotalCount, 8).unwrap(),
                    FieldSpecifier::new(ie::InformationElementId::systemInitTimeMilliseconds, 8).unwrap(),
                    FieldSpecifier::new(ie::InformationElementId::exporterIPv4Address, 4).unwrap(),
                    FieldSpecifier::new(ie::InformationElementId::exporterIPv6Address, 16).unwrap(),
                    FieldSpecifier::new(ie::InformationElementId::samplingInterval, 4).unwrap(),
                    FieldSpecifier::new(ie::InformationElementId::flowActiveTimeout, 2).unwrap(),
                    FieldSpecifier::new(ie::InformationElementId::flowIdleTimeout, 2).unwrap(),
                    FieldSpecifier::new(ie::InformationElementId::exportProtocolVersion, 1).unwrap(),
                    FieldSpecifier::new(ie::InformationElementId::exportTransportProtocol, 1).unwrap(),
                ],
            )])],
    );
