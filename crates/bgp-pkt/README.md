...
| Long-Lived Graceful Restart (LLGR) | [RFC 9494](https://datatracker.ietf.org/doc/html/rfc9494)                                                              |                                                                                               |
| FQDN (hostname)                    | [draft-walton-bgp-hostname-capability](https://datatracker.ietf.org/doc/html/draft-walton-bgp-hostname-capability-01)  | Individual draft rather than an RFC, but widely implemented (FRRouting, Cisco)                |
| PATHS-LIMIT                        | [draft-abraitis-idr-addpath-paths-limit](https://datatracker.ietf.org/doc/html/draft-abraitis-idr-addpath-paths-limit) | Individual draft rather than an RFC; advertised by FRRouting                                  |
| Experimental                       | [RFC 8810](https://datatracker.ietf.org/doc/html/RFC8810)                                                              | Capabilities with codes 239-254 are marked as experimental, we read their values as Box<[u8]> |
...
| Extended Communities          | [RFC 4360](https://datatracker.ietf.org/doc/html/rfc4360)                                                               | No         | Yes      | Yes        | Includes UPA transitive-opaque sub-type (draft-krierhorn-idr-upa)  |
...
| [RFC 4659](https://datatracker.ietf.org/doc/html/RFC4659)                                                                  | 2 = IPv6             | 128 = MPLS-labeled VPN address    |                                         |
