...
pub enum CommunityParsingError {
    #[error("while parsing community: {0}")]
...
pub enum ExtendedCommunityParsingError {
    #[error("while parsing extended community: {0}")]
    Parse(#[from] ParseError),
...
pub enum LargeCommunityParsingError {
    #[error("while parsing large community: {0}")]
    Parse(#[from] ParseError),
}
...
pub enum ExtendedCommunityIpv6ParsingError {
    #[error("while parsing extended community IPv6: {0}")]
    Parse(#[from] ParseError),
    ...
    #[error("in non-transitive IPv6 extended community: {0}")]
    NonTransitiveIpv6ExtendedCommunityError(#[from] NonTransitiveIpv6ExtendedCommunityParsingError),
    #[error("in unknown IPv6 extended community: {0}")]
