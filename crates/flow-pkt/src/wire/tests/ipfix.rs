...
fn test_with_variable_string_length() -> Result<(), IpfixPacketWritingError> {
    let good_template_wire = [
        0x00, 0x0a, 0x00, 0x36, 0x65, 0x85, 0xa8, 0xdd, 0x00, 0x01, 0xce, 0x06, 0x00, 0x00, 0x82,
        0x20, 0x00, 0x03, 0x00, 0x26, 0x01, 0x01, 0x00, 0x07, 0x00, 0x01, 0x01, 0x2e, 0x00, 0x04,
        0x01, 0x31, 0x00, 0x04, 0x01, 0x30, 0x00, 0x02, 0x01, 0x35, 0x00, 0x04, 0x01, 0x36, 0x00,
        0x04, 0x00, 0x54, 0x00, 0x5a, 0x01, 0x4f, 0xff, 0xff,
    ];
...
fn test_with_nokia_pen_fields() -> Result<(), IpfixPacketWritingError> {
    ...
    let good_data_wire = [
        0x00, 0x0a, 0x00, 0x52, 0x66, 0x74, 0x35, 0xe0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x01, 0x90, 0x00, 0x42, 0x0a, 0x64, 0x00, 0x01, 0x0a, 0x64, 0x00, 0x97, 0x27, 0x14,
        ...
        0x00, 0x04, 0xb0, 0x00, 0x00, 0x00, 0x01,
    ];
    let good_template = IpfixPacket::new(
...
fn test_with_vmware_pen_fields() -> Result<(), IpfixPacketWritingError> {
    ...
    let good_data_wire = [
        0x00, 0x0a, 0x00, 0x69, 0x66, 0x74, 0x35, 0xe0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x01, 0x90, 0x00, 0x59, 0x0a, 0x64, 0x00, 0x01, 0x0a, 0x64, 0x00, 0x97, 0x27, 0x14,
...
fn test_with_vendor_unknown_fields() -> Result<(), IpfixPacketWritingError> {
    ...
    let good_data_wire = [
        0x00, 0x0a, 0x00, 0x26, 0x66, 0x74, 0x35, 0xe0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x01, 0x90, 0x00, 0x16, 0x0a, 0x64, 0x00, 0x01, 0x01, 0x00, 0x00, 0x00, 0x01, 0x00,
        0x0a, 0x11, 0xee, 0x03, 0x02, 0xee, 0xff, 0x00,
    ];
...
fn test_with_unknown_pen() -> Result<(), IpfixPacketWritingError> {
    ...
    let good_data_wire = [
        0x00, 0x0a, 0x00, 0x2a, 0x66, 0x74, 0x35, 0xe0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x01, 0x90, 0x00, 0x1a, 0x0a, 0x64, 0x00, 0x01, 0x0a, 0x64, 0x00, 0x97, 0x01, 0x02,
        0x03, 0x04, 0x01, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x05,
    ];
...
#[test]
fn test_flow_set_len_bug() -> Result<(), IpfixPacketWritingError> {
    let template_wire = [
        0x00, 0x0a, 0x00, 0x26, 0x69, 0x49, 0x2a, 0x58, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x03, 0x00, 0x16, 0x01, 0xf4, 0x00, 0x03, 0x00, 0x01, 0x00, 0x5f, 0x00, 0x04,
        0x00, 0x60, 0xff, 0xff, 0x01, 0x74, 0xff, 0xff,
    ];

    let data_wire = [
        ,
    ];

    // The expected parsed template packet
    let template = IpfixPacket::new(
        ...
        Box::new([Set::OptionsTemplate(Box::new([
            OptionsTemplateRecord::new(
                500,
                Box::new([FieldSpecifier::new(ie::IE::applicationId, 4).unwrap()]),
                Box::new([
    ...
    // The expected parsed data packet
    let data = IpfixPacket::new(
        Utc.with_ymd_and_hms(2025, 12, 22, 11, 24, 8).unwrap(),
        10,
        0,
        Box::new([Set::Data {
            ...
            records: Box::new([
                DataRecord::new(
                    Box::new([ie::Field::applicationId(Box::new([0x0d, 0x00, 0x00, 0x50]))]),
                    Box::new([
                ...
                DataRecord::new(
                    Box::new([ie::Field::applicationId(Box::new([0x0d, 0x00, 0x00, 0x51]))]),
                    Box::new([
                        ie::Field::applicationName("name for id: 877825990".into()),
                        ie::Field::applicationCategoryName("category for id: 1742571168".into()),
                    ]),
                ),
                DataRecord::new(
                    Box::new([ie::Field::applicationId(Box::new([0x0d, 0x00, 0x00, 0x52]))]),
                    Box::new([
                        ie::Field::applicationName("name for id: 3318228306".into()),
                        ie::Field::applicationCategoryName("category for id: 3693899980".into()),
                    ]),
                ),
                DataRecord::new(
                    Box::new([ie::Field::applicationId(Box::new([0x0d, 0x00, 0x00, 0x53]))]),
                    Box::new([
                        ie::Field::applicationName("name for id: 3345427587".into()),
                        ie::Field::applicationCategoryName("category for id: 3062462844".into()),
                    ]),
                ),
                DataRecord::new(
                    Box::new([ie::Field::applicationId(Box::new([0x0d, 0x00, 0x00, 0x54]))]),
                    Box::new([
                        ie::Field::applicationName("name for id: 247430229".into()),
                        ie::Field::applicationCategoryName("category for id: 1508192498".into()),
                    ]),
                ),
                DataRecord::new(
                    Box::new([ie::Field::applicationId(Box::new([0x0d, 0x00, 0x00, 0x55]))]),
                    Box::new([
                        ie::Field::applicationName("name for id: 496746293".into()),
                        ie::Field::applicationCategoryName("category for id: 3398434384".into()),
                    ]),
                ),
                DataRecord::new(
                    Box::new([ie::Field::applicationId(Box::new([0x0d, 0x00, 0x00, 0x56]))]),
                    Box::new([
                        ie::Field::applicationName("name for id: 2764408791".into()),
                        ie::Field::applicationCategoryName("category for id: 2466434107".into()),
                    ]),
                ),
                DataRecord::new(
                    Box::new([ie::Field::applicationId(Box::new([0x0d, 0x00, 0x00, 0x57]))]),
                    Box::new([
                        ie::Field::applicationName("name for id: 2600679433".into()),
                        ie::Field::applicationCategoryName("category for id: 1670804265".into()),
                    ]),
                ),
                DataRecord::new(
                    Box::new([ie::Field::applicationId(Box::new([0x0d, 0x00, 0x00, 0x58]))]),
                    Box::new([
                        ie::Field::applicationName("name for id: 2533647043".into()),
                        ie::Field::applicationCategoryName("category for id: 888036656".into()),
                    ]),
                ),
                DataRecord::new(
                    Box::new([ie::Field::applicationId(Box::new([0x0d, 0x00, 0x00, 0x59]))]),
                    Box::new([
                        ie::Field::applicationName("name for id: 1342289478".into()),
                        ie::Field::applicationCategoryName("category for id: 3856588635".into()),
                    ]),
                ),
            ]),
        }]),
...
#[test]
fn test_string_variable_length() -> Result<(), IpfixPacketWritingError> {
    // value with length < u8::MAX to test single byte length encoding
    let small = "abcdefghijklmnopqrstuvwxyz";
    // value with length > u8::MAX to test three byte length encoding
    let large = "";

    let less_than_u8_wire = [
        0x1a, // Length = small.len() = 26
        0x61, 0x62, 0x63, 0x64, 0x65, 0x66, 0x67, 0x68, 0x69, 0x6a, 0x6b, 0x6c, 0x6d, 0x6e, 0x6f,
        0x70, 0x71, 0x72, 0x73, 0x74, 0x75, 0x76, 0x77, 0x78, 0x79, 0x7a,
    ];
    let larger_than_u8_wire = [
        0xff, // u8::MAX indicating three byte length follows
        0x00, 0x01, 0x04, // length = large.len() = 260
        0x61, 0x62, 0x63, 0x64, 0x65, 0x66, 0x67, 0x68, 0x69, 0x6a, 0x6b, 0x6c, 0x6d, 0x6e, 0x6f,
    ...
    let less_than_u8 = ie::Field::applicationName(small.into());
    ...
    test_write_with_one_input(&less_than_u8, None, &less_than_u8_wire)
        .expect("failed to write less than u8 with no length info");
    test_write_with_one_input(&less_than_u8, Some(u16::MAX), &less_than_u8_wire)
        .expect("failed to write less than u8 with u16::MAX length");
    test_write_with_one_input(
        &less_than_u8,
        Some(small.len() as u16),
        &less_than_u8_wire[1..],
    )
    .expect("failed to write less than u8 with exact length");
    test_write_with_one_input(&larger_than_u8, None, &larger_than_u8_wire)
        .expect("failed to write larger than u8 with no length info");
    test_write_with_one_input(&larger_than_u8, Some(u16::MAX), &larger_than_u8_wire)
        .expect("failed to write larger than u8 with u16::MAX length");
    test_write_with_one_input(
        &larger_than_u8,
        Some(large.len() as u16),
        &larger_than_u8_wire[4..],
    )
    .expect("failed to write larger than u8 with exact length");

    Ok(())
}

#[test]
fn test_octet_array_variable_length() -> Result<(), IpfixPacketWritingError> {
    // value with length < u8::MAX to test single byte length encoding
    let small_data: Vec<u8> = (0..26).collect();
    // value with length > u8::MAX to test three byte length encoding
    let large_data: Vec<u8> = (0..=255).cycle().take(260).collect();

    let less_than_u8_wire = {
        let mut wire = vec![0x1a]; // Length = small_data.len() = 26
        wire.extend_from_slice(&small_data);
        wire
    };
    ...
    let larger_than_u8_wire = {
        let mut wire = vec![
            0xff, // u8::MAX indicating three byte length follows
            0x00, 0x01, 0x04, // length = large_data.len() = 260
        ];
        wire.extend_from_slice(&large_data);
        wire
    };

    let less_than_u8 = ie::Field::paddingOctets(small_data.clone().into_boxed_slice());
    let larger_than_u8 = ie::Field::paddingOctets(large_data.clone().into_boxed_slice());
    ...
    // Test writing with no length info (should not write variable length)
    test_write_with_one_input(&less_than_u8, None, &less_than_u8_wire[1..])
        .expect("failed to write less than u8 with no length info");
    // Test writing with u16::MAX (variable length indicator)
    test_write_with_one_input(&less_than_u8, Some(u16::MAX), &less_than_u8_wire)
        .expect("failed to write less than u8 with u16::MAX length");
    // Test writing with exact length (should write without length prefix)
    test_write_with_one_input(
        &less_than_u8,
        Some(small_data.len() as u16),
        &less_than_u8_wire[1..],
    )
    .expect("failed to write less than u8 with exact length");

    // Test writing large octet array with no length info
    test_write_with_one_input(&larger_than_u8, None, &larger_than_u8_wire[4..])
        .expect("failed to write larger than u8 with no length info");
    // Test writing large octet array with u16::MAX
    test_write_with_one_input(&larger_than_u8, Some(u16::MAX), &larger_than_u8_wire)
        .expect("failed to write larger than u8 with u16::MAX length");
    // Test writing large octet array with exact length
    test_write_with_one_input(
        &larger_than_u8,
        Some(large_data.len() as u16),
        &larger_than_u8_wire[4..],
    )
    .expect("failed to write larger than u8 with exact length");
