        ...
        Box::new([Set::Data {
            ...
            records: Box::new([
                DataRecord::new(
                    Box::new([]),
                    Box::new([
                        ie::Field::mplsTopLabelStackSection([0x05, 0xde, 0x01]),
                        ie::Field::mplsLabelStackSection2([0x00, 0x00, 0x00]),
                        ie::Field::mplsLabelStackSection3([0x00, 0x00, 0x00]),
                        ie::Field::mplsLabelStackSection4([0x00, 0x00, 0x00]),
                        ie::Field::mplsLabelStackSection5([0x00, 0x00, 0x00]),
                        ie::Field::mplsLabelStackSection6([0x00, 0x00, 0x00]),
