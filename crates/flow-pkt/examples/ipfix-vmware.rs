...
fn main() {
        ...
        Box::new([Set::Data {
            ...
            records: Box::new([DataRecord::new(
                ...
                Box::new([
                    ...
                    ie::Field::VMWare(vmware::Field::virtualObsID(
    ...
    assert_eq!(
        buf,
        vec![
            // `virtualObsID` is declared variable-length (65535) in the
            // template above, so on the wire it is a 1-octet length
            // (0x24 = 36) followed by exactly those 36 octets of UUID.
            // RFC 7011 Section 7 adds no padding, hence no trailing NUL.
            0x00, 0x0a, 0x00, 0x69, 0x66, 0x74, 0x35, 0xe0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x01, 0x90, 0x00, 0x59, 0x0a, 0x64, 0x00, 0x01, 0x0a, 0x64, 0x00, 0x97,
