...
#[serde(untagged)]
pub enum LabelValue {
    /// u64 requires to be serialized as string according to JSON Encoding of
    /// YANG data specification from [RFC7951](https://datatracker.ietf.org/doc/html/rfc7951#section-6.1).
    NumberValue {
...
mod tests {
    ...
    fn test_telemetry_message_serde() {
        ...
        // Assert that the serialized JSON string matches the expected JSON
        // string
        assert_eq!(
