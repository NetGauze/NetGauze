...
fn test_bmp_v4_route_monitoring() -> Result<(), BmpMessageWritingError> {
    let good_wire = [
        ...
        0x00, 0x09, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0a, 0x00, 0x01, 0x00, 0x32, 0x00,
...
fn test_bmp_v4_route_monitoring_with_groups() -> Result<(), BmpMessageWritingError> {
    let good_wire = [
        ...
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xc0, 0x00,
        0x02, 0x34, 0x00, 0x01, 0x00, 0x00, 0xc0, 0x00, 0x02, 0x34, 0x64, 0x91, 0xa6, 0xa2, 0x00,
        0x0d, 0x51, 0x52, 0x00, 0x02, 0x00, 0x08, 0x84, 0x00, 0x00, 0x01, 0x00, 0x02, 0x00, 0x03,
        0x00, 0x04, 0x00, 0x03, 0x00, 0x06, 0x00, 0x00, 0x67, 0x6c, 0x6f, 0x62, 0x61, 0x6c, 0x00,
        0x09, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0a, 0x00, 0x01, 0x00, 0x32, 0x00, 0x00,
...
fn test_bmp_v4_route_monitoring_with_stateless_parsing() -> Result<(), BmpMessageWritingError> {
    let good_wire: [u8; 120] = [
        ...
        0, 2, 52, 0, 1, 0, 0, 192, 0, 2, 52, 100, 145, 166, 162, 0, 13, 81, 82, 0, 4, 0, 6, 0, 0,
        69, 4, 0, 1, 1, 3, 0, 1, 0, 54, 0, 0, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255,
...
fn test_bmp_v4_route_monitoring_without_stateless_parsing() -> Result<(), BmpMessageWritingError> {
    let good_wire: [u8; 108] = [
        ...
        0, 2, 52, 0, 1, 0, 0, 192, 0, 2, 52, 100, 145, 166, 162, 0, 13, 81, 82, 0, 1, 0, 54, 0, 0,
...
fn test_bmp_v4_path_marking() -> Result<(), BmpMessageWritingError> {
    let good_wire = [
        ...
        0x0d, 0x51, 0x52, 0x00, 0x03, 0x00, 0x03, 0x00, 0x00, 0x43, 0x31, 0x30, 0x00, 0x05, 0x00,
        0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0a, 0x00, 0x01, 0x00, 0x35, 0x00, 0x00, 0xff, 0xff,
...
fn test_bmp_v4_path_marking_invalid_with_reason() -> Result<(), BmpMessageWritingError> {
    let good_wire = [
        ...
        0x00, 0x00, 0x00, 0x01, 0x00, 0x38, 0xc0, 0x00, 0x1f, 0x9c, 0x64, 0x91, 0xa6, 0xda, 0x00,
        0x0d, 0x51, 0x52, 0x00, 0x03, 0x00, 0x03, 0x00, 0x00, 0x43, 0x31, 0x30, 0x00, 0x05, 0x00,
        0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x35, 0x00, 0x00,
        0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
